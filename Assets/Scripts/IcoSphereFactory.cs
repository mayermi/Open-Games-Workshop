...
public class IcoSphereFactory
{
    ...
    public GameObject Create(int subdivisions = 1)
    {
        if (subdivisions > 5 || subdivisions < 1)
            throw new ArgumentOutOfRangeException("Cannot have less than 1 or more than 5 subdivisions");
